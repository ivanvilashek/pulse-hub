...
export const BASE_BUTTON = tw`relative flex items-center justify-center rounded-md px-6 py-2 text-sm font-normal leading-6
...
const SECONDARY_BUTTON = tw`bg-transparent text-primary ring-1 ring-primary hover:bg-gray-1/10 
hover:text-purple-7 hover:ring-purple-7 active:bg-gray-2/20 active:text-purple-8 active:ring-purple-8 aria-disabled:bg-gray-2/30`
